 ...
 * @author Jim McClure
 */
@FacesConverter("com.qed.aes.system.ui.converters.DateOnlyConverter")
public class DateOnlyConverter implements javax.faces.convert.Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value != null) {
            try {
                ...
                LOGGER.log(Level.WARNING, "DateOnlyConverter: Unable to parse date: {0}", value);
            }
        }
