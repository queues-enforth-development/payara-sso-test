 ...
 * @author Jim McClure
 */
@FacesConverter("com.qed.aes.system.ui.converters.DateTimeMinuteConverter")
public class DateTimeMinuteConverter implements javax.faces.convert.Converter {
     ...
     * Our date format
     */
    private final SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy HH:mm");
